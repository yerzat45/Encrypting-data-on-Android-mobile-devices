...
public class AESActivity extends AppCompatActivity {
    ...
    private static final String KEY_FILE_NAME = "keyAES.docx";

    private EditText editTextKey;
    private EditText editTextGenerateKey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonEncrypt = findViewById(R.id.aesEncryptFileBtn);
        Button buttonDecrypt = findViewById(R.id.aesDecryptFileBtn);
            ...
            public void onClick(View v) {
                ...
                if (!key.isEmpty()) {
                    ...
                    try {
                        ...
                        Toast.makeText(AESActivity.this, "Key saved to " + keyFile.getAbsolutePath(), Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                        Toast.makeText(AESActivity.this, "Error saving key: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(AESActivity.this, "Please enter a key", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            if (uri != null) {
                try {
                    ...
                    if (requestCode == FILE_PICKER_REQUEST_CODE) {
                        outputFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "encryptedAES.docx");
                        ...
                        outputFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "decryptedAES.docx");
